...
class Encryption:
    ...
    def __init__(self):
        """"
        Initialises the class with a default shift value of 0; required for graceful exit on KeyboardInterrupt.
        """
        self.__shift_value = 0
    ...
    def encrypt(self):
        ...
        """
        cipher = '' # Initialise cipher string.
        ascii_uppercase_start = ord('A') # ASCII start for uppercase, used in Modulus formula below.
        ...
        for c in self.__word: # Loop through user's word or text.
            ...
            if c.isalpha() == False: # If a character in the user's word/text is not a letter, do not encrypt it; only copy it:
                ...
                cipher += chr((ascii_letter + self.__shift_value - ascii_uppercase_start) % 26 + ascii_uppercase_start) # After Z, formula allows wrapping back around to A.
            elif c.islower():
